...
function activity1() {
    ...
    <div class='divide'>
        <div style='margin-top: 2vw;'>
            <br>
            <h4 class="center-text fs-22px fb-700">ODE: Adam Bashforth Method</h4>
            <br>
...
function start_act1() {
    ...
    let text = `
      ...
      <div class="collapse divide text-center fs-18px" id="act1-div">
         ...
         <br>
         <p class="fs-18px fb-500" style="text-align: left">
            find y(0.4) using Adam Bashforth Predictor-Corrector method. <br>
         ...
         <div id='act1-verify-div'>
            <div class="row justify-content-center" style="align-items:center;">
               <div class="col-lg-9">
                  $$
                     y_4^p = y_3 + \\frac{h}{24} [55f(x_3,y_3) - 59f(x_2,y_2) +37f(x_1,y_1) - 9f(x_0, y_0)] = 
                  $$
               </div>
               <div class="col-md-3">
            ...
            <div class="row justify-content-center" style="align-items:center;">
               <div class="col-lg-9">
                  $$
                     y_4^c = y_3  + \\frac{h}{24} [9f(x_4, y_4^p) + 19f(x_3,y_3) - 5f(x_2,y_2) + f(x_1,y_1)] = 
                  $$
               </div>
               <div class="col-md-3">
...
function a1_verify_y_value() {
    ...
    div.innerHTML = `
   $$
      y_4^p = y_3 + \\frac{h}{24} [55f(x_3,y_3) - 59f(x_2,y_2) +37f(x_1,y_1) - 9f(x_0, y_0)] = ${parseFloat(yp_a1.toFixed(4))}
   $$
   $$
      y_4^c = y_3  + \\frac{h}{24} [9f(x_4, y_4^p) + 19f(x_3,y_3) - 5f(x_2,y_2) + f(x_1,y_1)] = ${parseFloat(yc_a1.toFixed(4))}
   $$
