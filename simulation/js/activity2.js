function activity2() {
    ...
    let text = `
      ...
      <div class="collapse divide text-center" id="act2-div">
         ...
         <br>
         <p class="fs-18px fb-500" style="text-align: left">
            find y(4) using Adam Bashforth Predictor-Corrector method.<br>
...
function a2_verify_y_value() {
    ...
    div.innerHTML = `
   $$
      y_4^p = y_3 + \\frac{h}{24} [55f(x_3,y_3) - 59f(x_2,y_2) +37f(x_1,y_1) - 9f(x_0, y_0)] = ${parseFloat(yp_a2.toFixed(4))}
   $$
   $$
      y_4^c = y_3  + \\frac{h}{24} [9f(x_4, y_4^p) + 19f(x_3,y_3) - 5f(x_2,y_2) + f(x_1,y_1)] = ${parseFloat(yc_a2.toFixed(4))}
   $$
